...
export default function Header({ onMenuToggle, sidebarCollapsed }: HeaderProps) {
  return (
    <header className="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-6 shadow-sm fixed top-0 left-0 right-0 z-50">
      <div className="flex items-center space-x-4">
        <button
          onClick={onMenuToggle}
          className="p-2 rounded-md hover:bg-slate-100 transition-colors border border-slate-300"
        >
